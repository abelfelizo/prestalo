...
const s = StyleSheet.create({
  banner: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 12, paddingVertical: 10, paddingHorizontal: 14, borderRadius: radius.md, borderWidth: 1 },
  bannerInfo: { backgroundColor: COLORS.indigoTint, borderColor: 'rgba(79,70,229,0.25)' },
  bannerWarn: { backgroundColor: COLORS.dangerTint, borderColor: 'rgba(239,68,68,0.3)' },
  texto: { flex: 1, fontFamily: font.bodyBold, fontSize: 13 },
  cta: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 8 },
  ctaText: { color: '#fff', fontSize: 12, fontFamily: font.bodyBold },
})
